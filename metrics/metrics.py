...
def compute_bcp(partition, edges, entrypoints=None):
    ...
    if entrypoints is None:
        entrypoints = [cls for cls in partition.keys() if cls.lower().endswith('controller') or cls.lower().endswith('action') or cls.lower().endswith('actionbean') or cls.lower().endswith('rest')]
