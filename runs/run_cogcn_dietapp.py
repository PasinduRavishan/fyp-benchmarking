...
def main():
    ...
    # Output CSV row
    commit_hash = "ccc497b672b8a1b1ab8182754021452e8e599086"
    date_str = "2026-07-20"
    runner = "Antigravity"
    notes = f"mean of 10 runs; CHM={means['CHM']:.3f} CHD={means['CHD']:.3f} BCP_entropy={means['BCP_entropy']:.3f}; Controllers treated as entrypoints; K={k}"
